"""
Django settings for learncare project.
...
SECRET_KEY = 'django-insecure-mo+-*kc)0(iy(4#_kcm*uf#do2j$m!3(3oqbt5of%ei2$4k%zt'
...
WSGI_APPLICATION = 'learncare.wsgi.application'
